 ...
 */
public class DistributedScenario extends AbstractScenario {
    ...
    public DistributedScenario(AbstractCVM cvm, String group, String[] groups) throws Exception {
        super(2000L, 10.0);
    ...
    private TestScenario getScenario(String t1, String s1) {
        ...
        return new TestScenario(clockURI, start, this.endInstant, new TestStepI[]{
                new TestStep(clockURI, t1, start.plusSeconds(10), thrust(o -> setupTurbine((WindTurbine)o))),
